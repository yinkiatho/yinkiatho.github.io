...
const ProjectView = () => {
    return (
      <Container
        id="projects"
        className="d-flex flex-wrap justify-content-center p-3 col-12"
        data-aos="zoom-in"
        data-aos-delay="100"
      >
        ...
        />
        <ProjectCards {...Data["Projects"]["RF-Optimization"]} />
        <ProjectCards {...Data["Projects"]["Streamlit-LSTM"]} />
        <ProjectCards
          {...Data["Projects"]["Algorithmic_Trading_using_XGBoost"]}
        />
        <ProjectCards {...Data["Projects"]["Orbital-BGS"]} />
        <ProjectCards {...Data["Projects"]["Watershed Properties Analysis"]} />
      </Container>
    );
}
...
export { ProjectView, PaperResumeView, AboutView, HeroView, FooterView, HeaderView, ResumeView };